                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl border text-sm font-bold transition-all ${role === "user" ? "bg-primary/20 border-primary text-primary shadow-glow-sm" : "bg-secondary/50 border-border text-muted-foreground hover:border-primary/50"}`}
                    >
                      Customer
                    </button>
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl border text-sm font-bold transition-all ${role === "owner" ? "bg-accent/20 border-accent text-accent shadow-glow-sm" : "bg-secondary/50 border-border text-muted-foreground hover:border-accent/50"}`}
                    >
                      Facility Owner
                    </button>
                  </div>
